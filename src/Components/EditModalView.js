...
export const EditModalView = ({ showModal, handleCloseEditModal, handleFormSubmission, taskTitle,
                                changeTaskTitle, taskLocation, taskDescription, changeTaskLocation,
                                changeTaskDescription, driver, handleDriverSelect, taskType,
                                handleTaskTypeSelect,taskStartDateTime, handleCalendarStartDateTimeChange,
                                taskEndDateTime, handleCalendarEndDateTimeChange, deleteTask
                            }) => {
  return (
    <Modal
      show={showModal}
    ...
    >
      ...
      <form onSubmit={handleFormSubmission}>
        <div className="form-group">
          ...
          <input className="form-control" id="task_name" value={taskTitle} onChange={changeTaskTitle} />
          <label htmlFor="task_name">Location</label>
          <input className="form-control" id="task_location" value={taskLocation} onChange={changeTaskLocation} />
          <label htmlFor="task_name">Description</label>
          <input className="form-control" id="task_description" value={taskDescription} onChange={changeTaskDescription} />
        </div>
        ...
        <div className="modal_dropdown">
          ...
          >
            <Dropdown.Item eventKey="Driver-1" selected>Driver-1</Dropdown.Item>
        ...
        <div className="form-group">
          ...
          <button className="form-control btn btn-primary" type="button" onClick={deleteTask}>
            Delete Task
          </button>
        </div>
      </form>
